...
def makebalancedb(in_args):

    print('makebalancedb in\n')
...
if __name__ == '__main__':
    ...
    print('reading bitcoin chainstate database')
    ...
    with sqlite3.connect(dbfile) as conn:
        ...
        expupdate = """
            ...
            """
        for add, val, height in parse_ldb(
                fin_name=args.chainstate,
                version=args.bitcoin_version,
